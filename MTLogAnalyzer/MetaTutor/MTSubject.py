...
from MetaTutor.Utils import Utils
...
#                
    ...
    def computeExtraAttributes(self, logger, nonValidTestQuestions, nbSubgoalsSetInitially, nbPagesInSystem, matTestPageDict, matPageSubgoalDict, minNoteTime):
        ...
        self.computeExtraDurationAttributes(logger)
        ...
        self.DurationDay2 = self.day2AllEvents[-1].timestamp - self.day2AllEvents[0].timestamp#duration of session during day 2
...
#        print "Score SGp:\t" + str(self.postTestScoreRelativeSubgoalPursued) + " / " + str(self.postTestMaxScoreSubgoalPursued)
    ...
    def computeExtraDurationAttributes(self, logger):
        ...
        self.sessionDuration = evtslist[-1].getTimeStart()     # session duration was initialized at 2 hours
        print "test:\t\t" + str(evtslist[-1].getTimeStart())
        evtslist = self.getEvents([Custom.CEvtPursuingNewSubgoal], 2)
        self.sessionDuration -= evtslist[0].getTimeEnd()
        print "1st SG:\t" + str(evtslist[0].getTimeEnd())
    ...
    def computeExtraPageRelevanceAttributes(self, logger, nbSubgoalsSetInitially, nbPagesInSystem, matPageSubgoal):
        ...
        # NJ THIS NEEDS TO BE CHANGED TO PREVENT DIVIDE BY ZERO
        for sgid in initialSubgoals:
