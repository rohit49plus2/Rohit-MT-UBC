...
for data in datasets:
    ...
    f = open(dir_path+'/results_smote/'+ep[0]+'/'+folder+'/SVM'+result_suffix+'_'+ep[0]+'_'+data+'.txt', 'w')
    ...
    with open(dir_path+'/results_smote/'+ep[0]+'/'+folder+'/SVM'+result_suffix+'_'+ep[0]+'_'+data+'.pickle', 'wb') as handle:
