...
d1=[24.57,16.83,19.75,32.22,31.93]
...
fig, ax = plt.subplots()
rects1 = ax.bar(x - width, d1, width, label='Non AOI',color='#F4D4D4',hatch='/')
rects2 = ax.bar(x , d2, width, label='AOI',color='#342A1F',hatch='.')
...
d1=[23.33,17.62,23.91,26.05,25.84]
