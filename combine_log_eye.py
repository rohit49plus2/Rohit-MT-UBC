...
for threshold in {3,4}:
    ...
    merged_full_half.to_pickle(dir_path+'/Combined_Data_2014/data_full_half_'+str(threshold)+'.pkl')
    merged_full_full.to_pickle(dir_path+'/Combined_Data_2014/data_full_full_'+str(threshold)+'.pkl')
