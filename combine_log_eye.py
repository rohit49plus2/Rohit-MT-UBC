...
for threshold in {3,4}:
    ...
    merged_15s_half.to_pickle(dir_path+'/Combined_Data/data_15s_half_'+str(threshold)+'.pkl')
    merged_15s_full.to_pickle(dir_path+'/Combined_Data/data_15s_full_'+str(threshold)+'.pkl')
    merged_full_half.to_pickle(dir_path+'/Combined_Data/data_full_half_'+str(threshold)+'.pkl')
