...
for threshold in {3,4}:
    ...
    merged_15s_prev.to_pickle(dir_path+'/Combined_Data/data_15s_prev.pkl')
    merged_15s_full.to_pickle(dir_path+'/Combined_Data/data_15s_full.pkl')
    merged_full_prev.to_pickle(dir_path+'/Combined_Data/data_full_prev.pkl')
    merged_full_full.to_pickle(dir_path+'/Combined_Data/data_full_full.pkl')
