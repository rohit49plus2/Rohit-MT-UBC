...
for data in datasets:
    ...
    f = open(dir_path+'/results/'+ep[0]+'/'+folder+'/RF'+result_suffix+'_'+ep[0]+'_'+data+'.txt', 'w')
    ...
    with open(dir_path+'/results/'+ep[0]+'/'+folder+'/RF'+result_suffix+'_'+ep[0]+'_'+data+'.pickle', 'wb') as handle:
