...
for data in datasets:
    ...
    f = open(dir_path+'/results/NN'+result_suffix+'_'+ep[0]+'_'+ep[1]+'_'+data+'.txt', 'w')
    ...
    with open(dir_path+'/results/NN'+result_suffix+'_'+ep[0]+'_'+ep[1]+'_'+data+'.pickle', 'wb') as handle:
